...
CKEDITOR.editorConfig = function( config ) {
    ...
    '/', 
    { name: 'insertMedia', items: ['Image','Image2', 'Flash', 'Video', 'Audio', 'EqnEditor', 'Mathjax'] },
    ...
    // IL - matching the configuration on the Data Warehouse (test.ccps solution)
    ...
    //// IL - Config image uploader (CKFinder) to match the one on the Data Warehouse (test.ccps -> OT_qCreator)
